                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-7 relative z-10">
                  ...
                  >
                    <div>
                      ...
                      <div className="p-3 rounded-xl bg-emerald-50/90 border border-emerald-600/30 mb-3 shadow-sm">
                        <div className="flex items-center justify-between mb-1.5">
                          <span className="text-xs font-bold text-stone-900">وضعیت فعلی:</span>
                          <span
                            className={`text-[11px] font-black px-2 py-0.5 rounded-full text-white shadow-sm ${
