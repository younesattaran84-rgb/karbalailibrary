  ...
  return (
    <section className="py-20 bg-[#073834] relative overflow-hidden border-b border-[#0d9488]/30">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Category Pills (only on full page) */}
        {!isHomePreview && (
        ...
        {/* Phase 5: View All Questions Button on Home page */}
        {isHomePreview && (
          <div className="mt-10 text-center">
            <button
              type="button"
              onClick={onViewAll}
              className="inline-flex items-center gap-2.5 px-8 py-3.5 rounded-2xl bg-gradient-to-r from-[#84cc16] to-[#65a30d] hover:from-[#a3e635] hover:to-[#84cc16] text-[#042f2e] font-black text-sm transition-all hover:scale-105 active:scale-95 shadow-xl shadow-[#84cc16]/20 border border-[#a3e635]/40"
            >
