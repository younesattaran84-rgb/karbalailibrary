          ...
          {featuredBooks.map((book, idx) => {
            return (
              <div
                ...
                className="relative rounded-3xl bg-gradient-to-br from-[#073834] to-[#042f2e] border-2 border-[#0d9488]/40 hover:border-[#84cc16] p-6 sm:p-8 shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col justify-between group cursor-pointer"
              >
                {/* Ribbon Tag */}
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="pt-2 flex items-center justify-end gap-3">
                  ...
                  >
                    ...
                    <span>مشاهده در کاتالوگ و رزرو امانت</span>
                  </button>
                </div>
