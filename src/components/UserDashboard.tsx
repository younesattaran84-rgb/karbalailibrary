                ...
                {loadingReservations ? (
                  ...
                  <div className="py-12 text-center text-xs text-[#99f6e4] space-y-3">
                    ...
                    >
                      ...
                      <span>مشاهده کاتالوگ و امانت کتاب</span>
                    </button>
                  </div>
                ) : (
                    ...
                    <div className="space-y-3">
                      {paginatedMessages.map((m) => (
                        ...
                        >
                          ...
                          {m.admin_reply ? (
                            <div className="p-3.5 rounded-xl bg-emerald-950/60 border border-[#84cc16]/50 text-[#a3e635] space-y-1 animate-in fade-in">
